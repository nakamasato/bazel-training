...
http_archive(
    ...
    sha256 = "6af9928520800691fa353603d5e810fb1d8394ae744d6ade2c15110d2d19b20b",
    strip_prefix = "grpc-1.65.3",
    urls = [
        "https://github.com/grpc/grpc/archive/refs/tags/v1.65.3.tar.gz",
    ],
)
